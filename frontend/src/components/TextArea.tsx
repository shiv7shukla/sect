  ...
  return (
    <div className='h-28 w-full flex flex-col items-center justify-between border-t-2 border-t-zinc-800 bg-[#111318] py-4 px-4'>
      <div className='w-full flex gap-4 '>
        ...
        <button className={`h-10 w-10 bg-emerald-400 rounded-xl ${isTyping? "opacity-100 cursor-pointer ": "opacity-50 cursor-default"} transition-all duration-300`}>
          <SendHorizonal className={`size-6 text-black translate-x-2 ${isTyping? "-rotate-90": "rotate-0" } transition-transform duration-300`}/>
        </button>
      </div>
