...
const ChatArea = () => {
  return (
    <div className='h-screen w-[78vw] bg-[#0C0E12] flex flex-col justify-center items-center'>
      <div className='h-24 w-24 mb-6 animate-float border-solid border-2 border-emerald-900 rounded-full corner-squircle flex items-center justify-center relative bg-[#12151A]'>        <div className='absolute inset-0 rounded-3xl shadow-[inset_0_0_20px_rgba(16,185,129,0.2)]'></div>
