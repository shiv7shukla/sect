...
const ChatArea = () => {
  return (
    <div className='h-screen w-[78vw] bg-[#0C0E12] flex flex-col justify-center items-center'>
      <div className='h-24 w-24 mb-6 animate-float bg-transparent border-solid border-2 border-emerald-900 rounded-full corner-squircle flex items-center justify-center relative  bg-[#12151A]'>
