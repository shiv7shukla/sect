...
const ConversationList = ({username, lastMessagePreview, lastMessageAt, selectedUser}: ConversationListProps) => {
  return (
    <>
      <div className={`h-16 w-[20vw] flex items-center justify-evenly gap-2 rounded-xl mb-2 bg-transparent transition-colors duration-200 hover:bg-[#171A21] px-2 hover:cursor-pointer ${selectedUser !== null ? "border-l-2 border-l-emerald-400" : "border-l-transparent"}`}>
